                        ...
                        <div class="custom_menu">
                            @if (Auth::user())
                                <ul>
                                    ...
                                    <li><a href="{{ route('client.newrelease') }}">New Releases</a></li>
                                    <li><a href="{{ route('client.todaysdeals') }}">Today's Deals</a></li>
                                    <li><a href="{{ route('client.customerservices') }}">Customer Service</a></li>
                ...
                <div class="containt_main">
                    <div id="mySidenav" class="sidenav">
                        ...
                        @foreach ($categories as $category)
                            <a
                                href="{{ route('client.category', [$category, $category->slug]) }}">{{ $category->category_name }}</a>
                        @endforeach
                    </div>
                    ...
                    <form class="main" style="margin-bottom: 70px" action="">
                        <div class="input-group">
                            <input type="search" class="form-control" name="search" placeholder="Search this blog">
                            <div>
                    ...
                    <div class="header_box">
                        ...
                        <div class="login_menu">
                            <ul>
                                <li><a href="{{ route('client.displayproduct') }}">
                                ...
                                @if (Auth::check() && Auth::user()->role_id === 2)
                                    <li>
                                        <a href="{{ route('client.userprofile') }}">
